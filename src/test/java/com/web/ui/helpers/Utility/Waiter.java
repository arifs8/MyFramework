...
//ELEMENT WAIT METHODS
     ...
     * @param specifiedTimeout - amount of seconds you want to wait for
     */
    public static void waitForElementToBeDisplayed(WebElement element, WebDriver driver, int specifiedTimeout) {            //OFTEN
...
//        wait.until(elementIsDisplayed);
     ...
     * @param specifiedTimeout - amount of seconds you want to wait for
     */
    public static void waitForElementToBeDisplayed(List<WebElement> element, WebDriver driver, int specifiedTimeout) {            //OFTEN
        WebDriverWait wait = new WebDriverWait(driver, specifiedTimeout);
        ExpectedCondition<Boolean> elementIsDisplayed = arg0 -> element.size() != 0;
        wait.until(elementIsDisplayed);
    }
...
// CLICK AND WAIT METHODS
    ...
    public static void waitForElementToBeClickable(WebDriver driver, WebElement element, long timeout) throws Exception {
    ...
    public static void waitForPageLoadComplete(WebDriver driver, int specifiedTimeout, TimeUnit seconds) {
    ...
    public static void waitTillElementisInvisible(WebDriver driver, WebElement element, long timeout) throws InterruptedException {
